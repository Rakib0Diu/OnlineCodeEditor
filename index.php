<?php 
  ...
  // 1. REMOVE the "if (!isset($_SESSION['username']))" block. 
  // This allows guests to see your editor without being forced to login.

  // 2. Update the logout logic to stay on the editor page
  if (isset($_GET['logout'])) {
  	session_destroy();
  	unset($_SESSION['username']);
  	
  	// Redirect to index.php (the editor) instead of login.php
...
<head>
  ...
  <title>Code Editor – Boundless Programming Academy</title>
...
<body>
  ...
  <header>
    ...
    <a href="index.php?logout=1">
      <button class="btn err">Logout</button>
    </a>
  <?php else: ?>
    <a href="login.php"><button class="btn secondary">Login</button></a>
